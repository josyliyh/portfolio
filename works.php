<!DOCTYPE html>
<html lang="en">
<?php $title = 'Portfolio of Josy Li | Works'; include 'head.php'?>
<body>
                    ...
                    <article class="single-project">
                                ...
                                <div class="project-description">
                                    <h2>Database Administration Interface</h2>
                                        <div class="project-skill-container">
                                            ...
                                            <p class="project-skill">PHP</p>
                                            <p class="project-skill">MAMP</p>
                                            <p class="project-skill">phpMyAdmin</p>
                        ...
                        <article class="single-project reveal">
                            <a href="https://josy.dev/game/" target="_blank" rel="noopener noreferrer">
                                <img src="./media/dog/wholetthedogsout-banner_wms4il_c_scale,w_985.png" alt="" class="project-image" loading="lazy">
                                ...
                                <div class="project-description">
                                    <h2>Who Let the Dogs Out</h2>
                                        <div class="project-skill-container">
                                            ...
                                            <p class="project-skill">CSS</p>
                                            <p class="project-skill">BootStrap</p>
